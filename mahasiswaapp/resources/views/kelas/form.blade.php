...
@section('content')
    <form action="{{isset($data)?route("edit.kelas",[$data->id]):route("simpan.kelas")}}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control @error("ruang") is-invalid @enderror" name="ruang" value="{{old("ruang",isset($data)?$data->ruang:"")}}">
        @error("ruang")
            <div class="invalid-feedback">
                {{$message}}
            </div>
        ...
        <div class="form-group">
            ...
            <select name="sesi" id="sesi"
                class="form-control">
                <option value="pagi"
                    {{isset($data)&&$data->sesi=="pagi"?"SELECTED":""}}>
                    Pagi</option>
                <option value="sore"
                {{isset($data)&&$data->sesi=="sore"?"SELECTED":""}}>
                    Sore</option>
            </select>
        </div>
